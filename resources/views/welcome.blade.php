                ...
                <div class="h-full flex flex-auto bg-purple-900 text-white bg-no-repeat bg-cover relative bg-image">
                    <div class="w-4/5 flex flex-auto flex-col md:flex-row items-center justify-center p-10 xl:p-32 overflow-hidden">
                        ...
                        <div class="w-4/5 z-10">
                            <h2 class="text-xl xl:text-3xl italic mb-6">わいプロ</h2>
                            <div class="text-4xl sm:text-5xl xl:text-7xl font-bold leading-tight mb-6">わいわい、楽しく<br>チーム開発をしよう！
                            </div>
                            <div class="sm:text-2xl xl:text-xl text-gray-200 font-normal">no more conflict</div>
                        </div>
